  ...
  <tr data-uid="#= _id #">
    <td colspan="100%" style='padding-left: 0; padding-right: 0; border-bottom: 1px solid \\#e5e5e5;'>
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5 callers-table-cell"> <span class="callers-col-inline-title"></span> #: company #</div>
          <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 callers-table-cell"> <span class="callers-col-inline-title"></span> #: name #</div>
          <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 callers-table-cell"> <span class="callers-col-inline-title"></span> #: ssn #</div>
        </div>
      </div>
    </td>
  </tr>`
