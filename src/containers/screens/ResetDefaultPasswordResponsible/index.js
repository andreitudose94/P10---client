...
import { changeResponsibleDefaultPassword, logout } from 'actions/responsibles.js'

import styles from './index.scss'

class ResetDefaultPasswordResponsible extends Component {
  constructor(props){
    super(props);
  ...
  handleSubmit(e){
    ...
    changeResponsibleDefaultPassword(password)
      .then((res) => {
        if (res.error) {
          return this.setState({
            alertShow: true,
...
export default injectIntl(ResetDefaultPasswordResponsible);
